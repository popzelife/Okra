...
class OKRListsUsers
{
        ...
        if($stmt = $this->_db->prepare($sql)) {
            ...
            if(!$this->sendVerificationEmail($u, $v)) {
                return "<h2> Error </h2>"
                    ...
                    . "<a href='mailto:help@okra.popzelife.me'>contact "
    ...
    private function sendVerificationEmail($email, $ver)
    {
        ...
        $subject = "[Okra] Please Verify Your Account";
 
        $headers = <<<MESSAGE
From: Okra <donotreply@okra.popzelife.me>
Content-Type: text/plain;
MESSAGE;
 
        $msg = <<<EMAIL
You have a new account at Okra!
...
Activate your account: http://okra.popzelife.me/accountverify.php?v=$ver&e=$e
 
If you have any questions, please contact help@okra.popzelife.me.
 
--
Thank you!
 
The Okra Team
www.okra.popzelife.me
EMAIL;
    ...
    private function sendResetEmail($email, $ver)
    {
        ...
        $subject = "[Okra] Request to Reset Your Password";
...
http://okra.popzelife.me/resetpassword.php?v=$ver&e=$e
